...
<?php endif; ?>
        ...
        <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('register')); ?>">
            ...
            <?php endif; ?>
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-3" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/laravel-posting-app/resources/views/auth/login.blade.php ENDPATH**/ ?>